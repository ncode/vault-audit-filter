...
Define the expected runtime and behavior guarantees for running the audit server on gnet v2 while preserving frame-processing compatibility during migration.
